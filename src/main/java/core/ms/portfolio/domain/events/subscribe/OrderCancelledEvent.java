...
public class OrderCancelledEvent implements DomainEvent {
    ...
    public OrderCancelledEvent(String orderId, String portfolioId, String reservationId, Symbol symbol, Currency currency, OrderType type, LocalDateTime occurredAt) {
