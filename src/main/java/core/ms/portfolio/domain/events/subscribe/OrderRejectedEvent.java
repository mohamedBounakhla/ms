...
public class OrderRejectedEvent implements DomainEvent {
    ...
    public OrderRejectedEvent(String orderId, String portfolioId, String reservationId, Symbol symbol, Currency currency, OrderType type, String reason, LocalDateTime occurredAt) {
